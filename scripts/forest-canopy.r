...
pacman::p_load(tidyverse, BIOMASS, hrbrthemes, gridExtra, openxlsx, stats, wrMisc,
vegan, BiodiversityR, here, MetBrewer, raster, rgdal, rgeos, raster, sf, stars, rasterVis)
...
all_landsat_bands <- list.files("data/landsat/LE07_L1TP_169055_20011215_20170202_01_T1/crop",
           pattern = ".tif$",
           full.names = TRUE)
